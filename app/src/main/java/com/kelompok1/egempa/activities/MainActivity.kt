...
import com.kelompok1.egempa.fragment.FragmentBerpotensi
import com.kelompok1.egempa.fragment.FragmentDirasakan
import com.kelompok1.egempa.fragment.FragmentTerkini
import com.kelompok1.egempa.networking.ApiEndpoint
import com.kelompok1.egempa.utils.BottomBarBehavior
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnLapor = findViewById<Button>(R.id.btnLapor)
    ...
    private fun getCuacaToday() {
        AndroidNetworking.get(ApiEndpoint.URL_CUACA)
                ...
                .addPathParameter("API key", "20a4fbb66ad2efdfc1a44743b8489d4a")
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    ...
                    override fun onResponse(response: JSONObject) {
                        try {
                            ...
                            tvKecepatanAngin.text = "Kecepatan Angin $strKecepatanAngin km/jam"
                            tvKelembaban.text = "Kelembaban $strKelembaban%"
                        } catch (e: JSONException) {
                            e.printStackTrace()
                            Toast.makeText(this@MainActivity, "Data cuaca bermasalah. Coba ulangi beberapa saat lagi.", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onError(anError: ANError) {
                        Toast.makeText(this@MainActivity, "Data cuaca bermasalah! Sepertinya ada masalah dengan koneksi internet kamu.", Toast.LENGTH_SHORT).show()
                    }
                })
    }
