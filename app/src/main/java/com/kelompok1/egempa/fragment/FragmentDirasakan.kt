...
import com.kelompok1.egempa.adapter.AdapterDirasakan
import com.kelompok1.egempa.model.ModelGempaDirasakan
        ...
        try {
            ...
            if (jsonArray != null) {
                for (i in 0 until jsonArray.length()) {
                    ...
                    dataApi.strKeterangan = jsonObject.getString("Wilayah") //untuk keterangan wilayah
                    dataApi.strDirasakan = jsonObject.getString("Dirasakan")
